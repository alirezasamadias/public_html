...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			// Load class strings.
			$this->strings = array(
				'page_title'                      => __( 'نصب پلاگین های اجابری', 'tgmpa' ),
				'menu_title'                      => __( 'نصب پلاگین ها', 'tgmpa' ),
				/* translators: %s: plugin name. */
				'installing'                      => __( 'در حال نصب پلاگین: %s', 'tgmpa' ),
				/* translators: %s: plugin name. */
				'updating'                        => __( 'در حال بروز رسانی پلاگین: %s', 'tgmpa' ),
