...
trait WP_QUERY_TRAIT {
	...
	protected function QuerySettings() {
		...
		RP_Utils::MULTIPLE_SELECT_FIELD( $this, 'post_type', 'نوع نوشته', $this->get_post_types(), [ 'post' ] );
		RP_Utils::MULTIPLE_SELECT_FIELD( $this, 'post_status', 'وضعیت نوشته', $POST_STATUS, [ 'publish' ] );
		...
		RP_Utils::SWITCH_FIELD( $this, 'exclude_this_post', 'نادیده گرفتن این پست', 'yes' );
		RP_Utils::NUMBER_FIELD( $this, 'posts_per_page', 'تعداد نوشته', - 1, 30 );
		RP_Utils::NUMBER_FIELD( $this, 'offset', 'offset', 0, 100, 1, 0, true, 'no_found_rows', '' );
		RP_Utils::SWITCH_FIELD( $this, 'ignore_sticky_posts', 'نادیده گرفتن پست های چسبان', 'yes' );
		RP_Utils::SWITCH_FIELD( $this, 'no_found_rows', 'نیاز به صفحه بندی', '' );
		...
		RP_Utils::SELECT_FIELD( $this, 'order', 'ترتیب', $order, 'DESC' );
		...
		RP_Utils::SELECT_FIELD( $this, 'orderby', 'مرتب سازی', $order_by, 'date' );
		$this->add_control(
			'meta_value_key',
			[
		...
		RP_Utils::SELECT_FIELD( $tax_query, 'operator', 'نوع عملیات', $TAXONOMY_OPERATORS, 'IN' );
