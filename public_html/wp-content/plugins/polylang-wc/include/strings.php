...
class PLLWC_Strings {
	...
	public function __construct() {
		...
		if ( PLL() instanceof PLL_Frontend ) {
			...
			add_action( 'init', array( $this, 'translate_strings_for_checkout_shortcode' ) ); // Translate strings on front the old way for shortcodes.
		} else {
	...
	/**
	 * Setups filters to translate strings for checkout shortcode.
	 *
	 * @since 1.9.5
	 *
	 * @return void
	 */
	public function translate_strings_for_checkout_shortcode() {
		// Gateways.
	 ...
	 */
	private function sanitize_text_field( string $string ): string {
